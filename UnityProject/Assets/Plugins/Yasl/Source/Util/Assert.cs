...
namespace Yasl.Internal
{
    public static class Assert
    {
        ...
        public static YaslException CreateException()
        {
            return new YaslException("Assert hit!");
        }

        public static YaslException CreateException(string message)
        {
            return new YaslException(message);
        }

        public static YaslException CreateException(string message, params object[] parameters)
        {
            return new YaslException(FormatString(message, parameters));
        }

        public static YaslException CreateException(Exception innerException, string message, params object[] parameters)
        {
            return new YaslException(FormatString(message, parameters), innerException);
        }
    }
}
